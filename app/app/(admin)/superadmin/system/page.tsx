...
export default async function SuperadminSystemPage() {
  const [system, feedback, tickets, pipeline] = await Promise.all([
    ...
    getPipelineStatus().catch(() => ({
      ...
      technical: { lastAt: null, dataDate: null, count: 0 },
      patterns: { lastAt: null, dataDate: null, count: 0 },
      elliott: { lastAt: null, dataDate: null, count: 0 },
      analysis: { lastAt: null, dataDate: null, count: 0 },
