...
const tiers: TierDef[] = [
  {
    ...
    entitlements: {
      "ai.queries_per_day": 5, // limit harian (reset 00:00 WIB)
  ...
  },
  {
    ...
    features: [
      ...
      "Daily Picks 3/hari",
      "AI Buddy 30 query/hari",
      "Trial 7 hari penuh",
    ],
    entitlements: {
      "ai.queries_per_day": 30,
  ...
  },
  {
    ...
    features: [
      ...
      "AI Buddy 300 query/hari + Deep Mode (Opus)",
      "API access read-only (rate-limited)",
    ],
    entitlements: {
      "ai.queries_per_day": 300,
      "watchlist.max_items": UNLIMITED,
      "alerts.max_active": UNLIMITED,
      "picks.daily_visible": 10,
